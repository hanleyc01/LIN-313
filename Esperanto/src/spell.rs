...
const LETTERS: &str = "abcĉdefgĥijĵklmnoprsŝtuŭvz";

const FNAME: &str = "esp-corpus.txt";

/// Structure with methods on it to abstract away the details of the spell-checker
pub struct Spell {
    words: HashBag<String>,
}

impl Spell {
    pub fn new(corpus: String) -> Result<Self, io::Error> {
